<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="hospital.aspx.cs" Inherits="Webdev_Assignment2.Entities.hospital" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="hospitalfield">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div id="hospitalsearchfield">
                    <asp:Label ID="Label1" class="LabelSite" runat="server" Text="HOSPITAL" Font-Bold="False"></asp:Label>
                    <br />
                    <br />
                ...
                <asp:GridView ID="GridView1" class="AllGridViews" OnPreRender="GridView1_PreRender" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:HyperLinkField Text="View" ControlStyle-CssClass="btn btn-warning btn-xs" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="hospitaldetails.aspx?id={0}">
                        ...
                        <asp:TemplateField ShowHeader="False">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary btn-sm" CausesValidation="False" CommandName="Edit" Text="Edit"></asp:LinkButton>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Webdev_Assignment2.DataBaseServerDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="Hospitals" OnSelecting="LinqDataSource1_Selecting">
                </asp:LinqDataSource>
                ...
                <asp:Panel ID="panel_insert" runat="server" class="Newbox panel panel-success">
                    <asp:Panel ID="Panel1" runat="server" class="panel-heading" Style="z-index: 1;">
                        <h3 class="panel-title" style="float: left;">Create new hospital</h3>
                    </asp:Panel>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="doctordetails.aspx.cs" Inherits="Webdev_Assignment2.Entities.doctordetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:FormView ID="DoctorFormView" class="bs-example form-horizontal" runat="server"
        ...
        <ItemTemplate>
            <asp:Label ID="Label1" class="LabelSite" runat="server" Text="DOCTOR DETAILS" Font-Bold="False"></asp:Label>
            <table id="tabledetails" class="table table-striped table-bordered table-hover" >
                <tr>
                    <td class="details_info"><b>Id:</b></td>
                    <td class="details_info"><asp:Label ID="IdLabel" runat="server" Text='<%# Bind("Id") %>' /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="details_info"><asp:Label ID="LicensenumberLabel" runat="server" Text='<%# Bind("Licensenumber") %>' /></td>
    ...
    <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Webdev_Assignment2.DataBaseServerDataContext" EntityTypeName="" TableName="Doctors" Select="new (Id, Name, Licensenumber, Dob, Address)" Where="Id == @Id">
        <WhereParameters>
